                ...
                <div className="product-nav-wrapper row">
                  ...
                  <div className="col-lg-8 col-md-7 product-filter-options">
                    ...
                    <ul className="account-user-actions">
                      <li><a href="!#" onClick={event => event.preventDefault()}><i className=" icon-magnifier"></i></a></li>
                      <li>
                        <a href="!#" onClick={event => event.preventDefault()}><i className="icon-basket"></i>
                    ...
                    <div className="card">
                      <div className="card-body">
                        <div className="action-holder">
                          ...
                          <span className="favorite-button"><i className=" icon-heart"></i></span>
                        </div>
