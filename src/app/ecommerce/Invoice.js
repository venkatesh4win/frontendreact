              ...
              <div className="card-body">
                ...
                <div className="container-fluid d-flex justify-content-between">
                  <div className="col-lg-3 pl-0">
                    <p className="mt-5 mb-2"><b>Stellar Admin React</b></p>
                ...
                <div className="container-fluid w-100">
                  <a href="!#" onClick={event => event.preventDefault()} className="btn btn-primary float-right mt-4 ml-2"><i className="icon-printer mr-1"></i>Print</a>
                  <a href="!#" onClick={event => event.preventDefault()} className="btn btn-success float-right mt-4"><i className=" icon-paper-plane mr-1"></i>Send Invoice</a>
                </div>
              </div>
            </div>
          </div>
