                ...
                <div className="row project-list-showcase">
                    ...
                    <div className="project-grid-inner">
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4"><i className="icon-menu mr-2"></i>50</div>
                          <div className="wrapper"><i className="icon-bubble mr-2"></i>321</div>
                        </div>
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      ...
                      <div className="d-flex justify-content-between flex-wrap align-items-center">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4"><i className="icon-menu mr-2"></i>45</div>
                          <div className="wrapper"><i className="icon-bubble mr-2"></i>123</div>
                        </div>
                        <div className="image-grouped">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    ...
                    <div className="project-grid-inner">
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4"><i className="icon-menu mr-2"></i>34</div>
                          <div className="wrapper"><i className="icon-bubble mr-2"></i>453</div>
                        </div>
                        <div className="image-grouped">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    ...
                    <div className="project-grid-inner">
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4"><i className="icon-menu mr-2"></i>65</div>
                          <div className="wrapper"><i className="icon-bubble mr-2"></i>651</div>
                        </div>
                        <div className="image-grouped">
                          <img className="img-xs rounded-circle" src={ require("../../assets/images/faces/face5.jpg") } alt="profile" />
                          <img className="img-xs rounded-circle" src={ require("../../assets/images/faces/face3.jpg") } alt="profile" />
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    <div className="project-grid-inner">
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4"><i className="icon-menu mr-2"></i>34</div>
                          <div className="wrapper"><i className="icon-bubble mr-2"></i>466</div>
                        </div>
                        <div className="image-grouped">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    ...
                    <img className="mb-3 mt-n3" src={ require("../../assets/images/brand_icons/oval-copy.jpg") } alt="profile" />
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4"><i className="icon-menu mr-2"></i>67</div>
                          <div className="wrapper"><i className="icon-bubble mr-2"></i>543</div>
                        </div>
                        <div className="image-grouped">
                          <img className="img-xs rounded-circle" src={ require("../../assets/images/faces/face9.jpg") } alt="profile" />
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-6 col-12 project-grid">
                    ...
                    <img className="mb-3 mt-n3" src={ require("../../assets/images/brand_icons/oval.jpg") } alt="brand" />
                      ...
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        <div className="action-tags d-flex flex-row">
                          <div className="wrapper pr-4"><i className="icon-menu mr-2"></i>87</div>
                          <div className="wrapper"><i className="icon-bubble mr-2"></i>558</div>
                        </div>
                        <div className="image-grouped">
                          <img className="img-xs rounded-circle" src={ require("../../assets/images/faces/face10.jpg") } alt="profile" />
                        </div>
