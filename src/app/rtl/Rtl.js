                ...
                <div className="card">
                  <div className="card-body performane-indicator-card">
                    <div className="d-sm-flex">
                      <h4 className="card-title flex-shrink-1"><Trans>
                        Performance Indicator
                      </Trans></h4>
                      <p className="m-sm-0 mr-sm-auto flex-shrink-0">
                        <span className="data-time-range mr-0">7d</span>
                    ...
                    <div className="d-sm-flex flex-wrap mt-3">
                      <div className="d-flex align-items-center">
                        <span className="dot-indicator bg-primary mr-2"></span>
                        <p className="mb-0 mr-2 text-muted font-weight-semibold"><Trans>
                          Complaints
                        </Trans> (2098)</p>
                      </div>
                      <div className="d-flex align-items-center">
                        <span className="dot-indicator bg-info mr-2"></span>
                        <p className="mb-0 mr-2 text-muted font-weight-semibold"> <Trans>
                          Task Done
                        </Trans> (1123)</p>
                      </div>
                      <div className="d-flex align-items-center">
                        <span className="dot-indicator bg-danger mr-2"></span>
                        <p className="mb-0 mr-2 text-muted font-weight-semibold"><Trans>
                          Attends
                        </Trans> (876)</p>
                      </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="aligner-wrapper py-3">
                      ...
                      <div className="wrapper d-flex flex-column justify-content-center absolute absolute-center">
                        ...
                        <small className="d-block text-center text-muted  font-weight-semibold mb-0"><Trans>
                          Total Leads
                        </Trans></small>
                      </div>
                    </div>
                    <div className="wrapper mt-4 d-flex flex-wrap align-items-cente">
                      <div className="d-flex">
                        <span className="square-indicator bg-danger mr-2"></span>
                        <p className="mb-0 mr-2"><Trans>
                          Assigned
                        </Trans></p>
                      </div>
                      <div className="d-flex">
                        <span className="square-indicator bg-success mr-2"></span>
                        <p className="mb-0 mr-2"><Trans>
                          Not Assigned
                        </Trans></p>
                      </div>
                      <div className="d-flex">
                        <span className="square-indicator bg-warning mr-2"></span>
                        <p className="mb-0 mr-2"><Trans>
                          Reassigned
                        </Trans></p>
                      </div>
              ...
              <div className="col-md-12 grid-margin">
                <div className="card">
                  <div className="card-header d-block d-md-flex">
                    <h5 className="mb-0"><Trans>
                      Quick Actions
                    </Trans></h5>
                    <p className="mr-auto mb-0"><Trans>
                      How are your active users trending overtime?
                    </Trans><i className="icon-bulb"></i></p>
                  </div>
                  <div className="d-md-flex row m-0 quick-action-btns" role="group" aria-label="Quick action buttons">
                    <div className="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <button type="button" className="btn px-0"> <i className="icon-user ml-2"></i> <Trans>
                        Add Client
                      </Trans></button>
                    </div>
                    <div className="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <button type="button" className="btn px-0"><i className="icon-docs ml-2"></i> <Trans>
                        Create Quote
                      </Trans></button>
                    </div>
                    <div className="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <button type="button" className="btn px-0"><i className="icon-folder ml-2"></i> <Trans>
                        Enter Payment
                      </Trans></button>
                    </div>
                    <div className="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <button type="button" className="btn px-0"><i className="icon-book-open ml-2"></i><Trans>
                        Create Invoice
                      </Trans></button>
                    </div>
                  </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-sm-flex align-items-center mb-4">
                    <h4 className="card-title mb-sm-0"><Trans>
                      Products Inventory
                    </Trans></h4>
                    <a href="!#" onClick={evt => evt.preventDefault()} className="text-dark mr-auto mb-3 mb-sm-0"> <Trans>
                      View all Products
                    </Trans></a>
                  </div>
                  <div className="table-responsive border rounded p-1">
                    <table className="table">
                      <thead>
                        <tr>
                          <th className="font-weight-bold"><Trans>
                            Store ID
                          </Trans></th>
                          <th className="font-weight-bold"><Trans>
                            Amount
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>$3621</td>
                          <td><img src={require('../../assets/images/dashboard/alipay.png')} alt="alipay" className="gateway-icon ml-2" /> alipay</td>
                          <td>04 <Trans>
                            Jun
                          </Trans> 2019</td>
                          <td>18 <Trans>
                          ...
                          <td>
                            <div className="badge badge-success p-2"><Trans>
                              Paid
                            </Trans></div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>$6245</td>
                          <td><img src={require('../../assets/images/dashboard/paypal.png')} alt="alipay" className="gateway-icon ml-2" /> <Trans>
                            Paypal
                          </Trans></td>
                          <td>25 <Trans>
                            Sep
                          ...
                          <td>
                            <div className="badge badge-danger p-2"><Trans>
                              Pending
                            </Trans></div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <div className="badge badge-warning p-2"><Trans>
                              Failed
                            </Trans></div>
                          </td>
                        </tr>
                  ...
                  <div className="d-flex mt-4 flex-wrap align-items-center">
                    <p className="text-muted mb-sm-0"><Trans>
              ...
              <div className="card sales-report-country">
                <div className="card-body">
                  <div className="d-md-flex">
                    ...
                    <div className="mb-2 m-md-0 mr-md-auto">
                      <a href="!#" onClick={evt => evt.preventDefault()} className="text-secondary ml-3 d-inline-block mb-3"><i className="icon-cloud-upload ml-3"></i> <Trans>
                        Export File
                      </Trans></a>
                      <a href="!#" onClick={evt => evt.preventDefault()} className="text-secondary ml-3 d-inline-block"><i className="icon-printer ml-3"></i><Trans>
                        Print File
                      </Trans></a>
                    </div>
                  </div>
                  <div className="row my-xl-3">
                    <div className="col-md-12 d-md-flex">
                      <div>
                        ...
                        <p className="text-muted"><Trans>
                          +23 since last year
                        </Trans></p>
                      </div>
                      <div className="mr-md-3">
                        <p className="mb-0 mt-2"><Trans>Sales performance of all states in the world</Trans></p>
                    ...
                    <div className="col-xl-4 pt-3">
                      <div className="row">
                        ...
                        <div className="pt-xl-3 col-sm-6 col-xl-12 sales-activity">
                          ...
                          <p className="text-muted pb-0"><Trans>
                            Updated
                          </Trans>-5:14 pm</p>
                        </div>
                      </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-sm-flex align-items-center">
                    <h4 className="card-title mb-0"><Trans>
                      Latest Activity
                    </Trans></h4>
                    <a href="!#" onClick={evt => evt.preventDefault()} className="btn btn-outline-info border-0 font-weight-semibold mr-auto p-0 btn-no-hover-bg"><Trans>
                      View more
                    </Trans></a>
                  </div>
                  <div className="d-flex mt-4 py-3 border-bottom">
                    ...
                    <div className="wrapper mr-2">
                      <p className="mb-1 font-weight-medium"><Trans>
                        Mobile Apps Redesign
                      </Trans></p>
                      <small className="text-muted"><Trans>
                        +23 since last year
                      </Trans></small>
                    </div>
                    <small className="text-muted mr-auto">10:07PM</small>
                  </div>
                  <div className="d-flex py-3 border-bottom">
                    ...
                    <div className="wrapper mr-2">
                      <p className="mb-1 font-weight-medium"><Trans>
                        Inviting Join Apps Cont...
                      </Trans></p>
                      <small className="text-muted"><Trans>
                        +23 since last year
                      </Trans></small>
                    </div>
                    <small className="text-muted mr-auto">01:07AM</small>
                  </div>
                  <div className="d-flex py-3 border-bottom">
                    ...
                    <small className="text-muted mr-auto">04:42AM</small>
                  </div>
                  <div className="d-flex py-3  border-bottom">
                    ...
                    <small className="text-muted mr-auto">07:44PM</small>
                  </div>
                  <div className="d-flex pt-3">
                    ...
                    <small className="text-muted mr-auto">10:49AM</small>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="card-body">
                  <div className="row income-expense-summary-chart-text">
                    <div className="col-xl-4">
                      ...
                      <p className="small text-muted"><Trans>
                        A comparison of people who mark themselves of their ineterest from the date range given above. Learn more.
                      </Trans></p>
                    </div>
                    <div className=" col-md-3 col-xl-2">
                      <p className="income-expense-summary-chart-legend"> <span style={{ borderColor : '#6469df' }}></span> <Trans>
                        Total Income
                      </Trans> </p>
                      <h3>$ 1,766.00</h3>
                    </div>
                    <div className="col-md-3 col-xl-2">
                      <p className="income-expense-summary-chart-legend"> <span style={{ borderColor : '#37ca32'}}></span> <Trans>
                        Total Expense
                      </Trans> </p>
                      <h3>$ 5,698.30</h3>
                    </div>
                    <div className="col-md-6 col-xl-4 d-flex align-items-center">
                      <DateRangePicker 
                        className="mr-auto income-expense-summary-chart-daterange" 
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="d-sm-flex align-items-baseline report-summary-header">
                        <h5 className="font-weight-semibold"><Trans>
                          Report Summary
                        </Trans></h5> <span className="mr-auto"><Trans>
                          Updated Report
                        </Trans></span> <button className="btn btn-icons border-0 p-2"><i className="icon-refresh"></i></button>
                      </div>
                    </div>
                  </div>
                  <div className="row report-inner-cards-wrapper">
                    <div className=" col-md -6 col-xl report-inner-card">
                      <div className="inner-card-text">
                        <span className="report-title"><Trans>
                          EXPENSE
                        </Trans></span>
                        <h4>$32123</h4>
                        <span className="report-count"> 2 <Trans>
                          Reports
                        </Trans></span>
                      </div>
                    ...
                    <div className="col-md-6 col-xl report-inner-card">
                      <div className="inner-card-text">
                        ...
                        <h4>95,458</h4>
                        <span className="report-count"> 3 <Trans>
                          Reports
                        </Trans></span>
                      </div>
                    ...
                    <div className="col-md-6 col-xl report-inner-card">
                      <div className="inner-card-text">
                        ...
                        <h4>2650</h4>
                        <span className="report-count"> 5 <Trans>
                          Reports
                        </Trans></span>
                      </div>
                    ...
                    <div className="col-md-6 col-xl report-inner-card">
                      <div className="inner-card-text">
                        ...
                        <h4>25,542</h4>
                        <span className="report-count"> 9 <Trans>
                          Reports
                        </Trans></span>
                      </div>
                    ...
                    <div className="col-md-6">
                      <div className="quick-status-circular-progress">
                        ...
                        >
                          ...
                          <p className="circle-progress-label"><Trans>
                            Expense
                          </Trans></p>
                        </CircularProgressbarWithChildren>
                      </div>
                  ...
                  <div className="row mt-5">
                    <div className="col-12">
                      <div className="wrapper py-4 d-flex border-bottom">
                        ...
                        <div className="mr-auto"><i className="icon-arrow-down-circle"></i><span className="text-muted mr-2">2.87 %</span></div>
                      </div>
