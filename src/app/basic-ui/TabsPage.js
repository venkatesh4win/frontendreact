              ...
              <div className="card-body">
                ...
                <Tabs defaultActiveKey="home" id="uncontrolled-tab-example">
                  ...
                  <h4>Contact us </h4>
                    ...
                    <p>
                      <i className="icon-phone text-info mr-2"></i>
                      +123456789
                    </p>
                    <p>
                      <i className="icon-envelope text-success mr-2"></i>
                        ...
                        <Nav variant="pills" className="flex-column">
                          <Nav.Item>
                            <Nav.Link eventKey="first" className="d-flex align-items-center">
                              <i className="icon-home text-primary pr-2"></i>
                              Home
                            </Nav.Link>
                          </Nav.Item>
                          <Nav.Item>
                            <Nav.Link eventKey="second" className="d-flex align-items-center">
                              <i className=" icon-user text-danger pr-2"></i>
                              Profile
                            </Nav.Link>
                          </Nav.Item>
                          <Nav.Item>
                            <Nav.Link eventKey="third" className="d-flex align-items-center">
                              <i className="icon-envelope-open text-success pr-2"></i>
                              Mail
                            </Nav.Link>
                          </Nav.Item>
                        </Nav>
