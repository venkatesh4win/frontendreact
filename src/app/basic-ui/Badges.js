                  ...
                  <table className="table mb-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="pr-0 text-right"><div className="badge badge-pill badge-primary"><i className=" icon-user"></i></div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Outlined Icons</td>
                        <td className="pr-0 text-right"><div className="badge badge-pill badge-outline-info"><i className=" icon-cloud-upload"></i></div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Icon With Text</td>
                        <td className="pr-0 text-right"><div className="badge badge-pill badge-danger"><i className="icon-envelope mr-2"></i>12</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Icon With Text</td>
                        <td className="pr-0 text-right"><div className="badge badge-pill badge-success">12<i className="icon-envelope ml-2"></i></div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Icon Badge</td>
                        <td className="pr-0 text-right"><div className="badge badge-pill badge-warning"><i className="icon-speech"></i></div></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
