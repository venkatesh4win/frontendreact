                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="1">
                        <Card.Body>
                          ...
                          <br/>
                          <p className="text-success"><i className="icon-info mr-2"></i>If the problem persists, you can contact our support. </p>
                        </Card.Body>
                      </Accordion.Collapse>
                    </Card>
                    <Card>
                    ...
                    <Card>
                      ...
                      <Accordion.Collapse eventKey="1">
                        ...
                        <p> If while signing in to your account you see an error message, you can do the following </p>
                          ...
                          <br/>
                          <i className="icon-info mr-2"></i>If the problem persists, you can contact our support.
                        </Card.Body>
                      </Accordion.Collapse>
                    </Card>
                    <Card>
