          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center">
                <Button onClick={() => setLgShow(true)} className="btn-sm">Large modal<i className=" icon-arrow-up-circle ml-1"></i></Button>
              </div>
              <Modal
                size="lg"
                show={lgShow}
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-description">Normal modal with default bootstrap settings</p>
                ...
                {/* Modal starts */}
                <div className="text-center">
                  <Button onClick={() => setMdShow(true)} className="btn-sm">Medium modal<i className=" icon-arrow-up-circle ml-1"></i></Button>
                </div>
                <Modal
                  show={mdShow}
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-description">Small modal with max-width set to 300px</p>
                ...
                {/* Modal starts */}
                <div className="text-center">
                  <Button onClick={() => setSmShow(true)} className="btn-sm">Small modal<i className=" icon-arrow-up-circle ml-1"></i></Button>
                </div>
                <Modal
                  size="sm"
                  show={smShow}
