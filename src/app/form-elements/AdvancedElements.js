                    ...
                    <div className="col-md-4 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <Rating 
                                    initialRating="1"
                                    emptySymbol={<i className="icon-star text-muted mr-1" style={{fontSize:'20px', marginRight: '2px', display:'block'}}></i>}
                                    fullSymbol={<i className="icon-star text-primary mr-1" style={{fontSize:'20px', marginRight: '2px'}}></i>}
                                />
                            </div>
                        </div>
                    </div>
