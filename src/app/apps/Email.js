          ...
          <div className="row align-items-stretch">
            <div className="mail-sidebar d-none d-lg-block col-xl-2 pt-3 bg-white">
              <div className="menu-bar">
                <ul className="menu-items">
                  ...
                  <li className="active"><a href="!#" onClick={evt =>evt.preventDefault()}><i className="icon-envelope"></i> Inbox</a><span className="badge badge-pill badge-success">8</span></li>
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><i className="icon-action-redo"></i> Sent</a></li>
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><i className=" icon-doc"></i> Draft</a><span className="badge badge-pill badge-warning">4</span></li>
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><i className="icon-cloud-upload"></i> Outbox</a><span className="badge badge-pill badge-danger">3</span></li>
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><i className="icon-star"></i> Starred</a></li>
                  <li><a href="!#" onClick={evt =>evt.preventDefault()}><i className="icon-trash"></i> Trash</a></li>
                </ul>
            ...
            <div className="mail-list-container col-xl-3 pt-4 pb-4 border-right bg-white">
              ...
              <div className="mail-list new_mail">
                ...
                <div className="details">
                  <i className="icon-star favorite"></i>
                </div>
              </div>
              <div className="mail-list">
                <div className="form-check"> <label className="form-check-label"> <input type="checkbox" className="form-check-input"/><i className="input-helper"></i> </label></div>
            ...
            <div className="mail-view d-none d-md-block col-xl-7 bg-white">
                ...
                <div className="col-md-12 mb-4 mt-4">
                  <div className="btn-toolbar">
                    <div className="btn-group">
                      <button type="button" className="btn btn-sm btn-outline-secondary"><i className="icon-action-undo text-primary mr-1"></i> Reply</button>
                      <button type="button" className="btn btn-sm btn-outline-secondary"><i className="icon-action-undo text-primary mr-1"></i>Reply All</button>
                      <button type="button" className="btn btn-sm btn-outline-secondary"><i className="icon-action-redo text-primary mr-1"></i>Forward</button>
                    </div>
                    <div className="btn-group">
                      <button type="button" className="btn btn-sm btn-outline-secondary"><i className="icon-paper-clip text-primary mr-1"></i>Attach</button>
                      <button type="button" className="btn btn-sm btn-outline-secondary"><i className="icon-trash text-primary mr-1"></i>Delete</button>
                    </div>
                  </div>
                </div>
              </div>
              <div className="message-body">
                ...
                <div className="message-content">
                  ...
                  <p>For the coming week the highest priority is given to the development for <a href="!#" onClick={evt=>evt.preventDefault()}>http://www.stellar.com/</a> once the design is approved and necessary improvements are made.</p>
                  <p><br/><br/>Regards,<br/>Sarah Graves</p>
                </div>
                <div className="attachments-sections">
                  <ul>
                    <li>
                      <div className="thumb"><i className=" icon-doc"></i></div>
                      <div className="details">
