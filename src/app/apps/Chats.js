      ...
      <div>
        ...
        <div className="row">
          <div className="col-md-12">
            <button type="button" className="btn btn-secondary py-3 mb-4 text-center d-md-none" onClick={this.asideToggler}><i className="icon-menu mr-0 icon-md"></i></button>
                ...
                <div className="col-xl-6 col-md-8 px-0 d-flex flex-column">
                  <div className="chat-container-wrapper">
                    ...
                    <div className="chat-bubble outgoing-chat">
                      <div className="chat-message">
                        <p className="font-weight-semibold">Frank Carter</p>
                    ...
                    <div className="chat-bubble outgoing-chat">
                      <div className="chat-message">
                        <p className="font-weight-semibold">Frank Carter</p>
                        <p>Leo duis ut diam quam nulla porttitor massa id neque. Sed enim ut sem</p>
                        <p className="font-weight-medium"><i className="icon-paper-clip mr-2"></i>workfile.pdf</p>
                      </div>
                      <div className="sender-details">
                        <img className="sender-avatar img-xs rounded-circle" src={require("../../assets/images/faces/face3.jpg")} alt="profile" />
                        <p className="seen-text">Message seen : 10 min ago</p>
                    ...
                    <form action="#">
                      <div className="input-group">
                        <div className="input-group-prepend">
                          <button type="button" className="input-group-text"><i className=" icon-emotsmileicon-sm"></i></button>
                        </div>
                        <input type="text" className="form-control" placeholder="Type a message here" />
                        <div className="input-group-append">
                          <button type="button" className="input-group-text"><i className="icon-paper-clip icon-sm"></i></button>
                        </div>
                        <div className="input-group-append">
                          <button type="submit" className="input-group-text"><i className=" icon-paper-plane icon-sm"></i></button>
                        </div>
                      </div>
                    </form>
                  </div>
                  ...
                  <div className="px-4">
                    ...
                    <div className="list-item">
                      <div className="d-flex align-items-center justify-content-center img-sm badge-success">
                        <i className=" icon-wallet icon-sm"></i></div>
                    ...
                    <div className="list-item border-bottom-0">
                      ...
                      <div className="wrapper pl-3 w-100">
                        ...
                        <div className="d-flex">
                          <p className="text-muted mb-0">Deposit</p>
                          <p className="font-weight-semibold ml-auto">4.7 GB free</p>
                        </div>
                      </div>
                    </div>
