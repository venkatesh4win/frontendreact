                ...
                <div className="tickets-tab-switch">
                  ...
                  <Tab.Content className="w-100 px-0">
                    <Tab.Pane eventKey="first">
                      <div>
                        <div className="tickets-date-group"><i className="icon-calendar"></i>Tuesday, 21 May 2019 </div>
                        <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                          <div className="tickets-details col-lg-7 col-12">
                            ...
                            <div className="wrapper text-muted d-none d-md-block">
                              ...
                              <span><i className=" icon-clock"></i>03:34AM</span>
                            </div>
                          </div>
                          ...
                          <div className="ticket-float col-lg-2 col-sm-6 d-none d-md-block">
                            <i className="category-icon icon-folder"></i>
                        ...
                        <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                          <div className="tickets-details col-lg-7 col-12">
                            ...
                            <div className="wrapper text-muted d-none d-lg-block">
                              ...
                              <span><i className=" icon-clock"></i>04:23AM</span>
                            </div>
                          </div>
                        ...
                        <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                          <div className="tickets-details col-lg-7">
                            ...
                            <div className="wrapper text-muted d-none d-md-block">
                              ...
                              <span><i className=" icon-clock"></i>04:24AM</span>
                            </div>
                          </div>
                        ...
                        <div className="tickets-date-group"><i className="icon-calendar"></i>Tuesday, 20 Apr,2019 </div>
                        <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                          <div className="tickets-details col-lg-7">
                            <div className="wrapper">
                            ...
                            <div className="wrapper text-muted d-none d-md-block">
                              ...
                              <span><i className=" icon-clock"></i>12:54PM</span>
                            </div>
                          </div>
                          <div className="ticket-float col-lg-3 col-sm-6 pr-0">
                        ...
                        <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                          <div className="tickets-details col-lg-7">
                            ...
                            <div className="wrapper text-muted d-none d-md-block">
                              ...
                              <span><i className=" icon-clock"></i>4:19AM</span>
                            </div>
                          </div>
                          <div className="ticket-float col-lg-3 col-sm-6 pr-0">
                        ...
                        <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                          <div className="tickets-details col-lg-7">
                            ...
                            <div className="wrapper text-muted d-none d-md-block">
                              ...
                              <span><i className=" icon-clock"></i>01:27PM</span>
                            </div>
                          </div>
                          <div className="ticket-float col-lg-3 col-sm-6 pr-0">
                            <img className="img-xs rounded-circle" src={ require("../../assets/images/faces/face10.jpg") } alt="profile" />
                        ...
                        <a href="!#" className="tickets-card row mx-0" onClick={evt =>evt.preventDefault()}>
                          <div className="tickets-details col-lg-7">
                            ...
                            <div className="wrapper text-muted d-none d-md-block">
                              ...
                              <span><i className=" icon-clock"></i>06:16PM</span>
                            </div>
                          </div>
                          <div className="ticket-float col-lg-3 col-sm-6 pr-0">
