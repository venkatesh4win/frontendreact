                  ...
                  <div className="col-lg-8">
                    ...
                    <div className="mt-4 py-2 border-top border-bottom">
                      <ul className="nav profile-navbar">
                        ...
                        <li className="nav-item">
                          <a className="nav-link d-flex align-items-center" href="!#" onClick={event => event.preventDefault()}>
                            <i className="icon-paper-clip mr-1"></i>
                            Resume
                          </a>
                        </li>
                      </ul>
                    ...
                    <div className="profile-feed">
                      <div className="d-flex align-items-start profile-feed-item">
                        ...
                        <div className="ml-4">
                          <h6>
                            Mason Beck
                            <small className="ml-4 text-muted"><i className=" icon-clock mr-1"></i>10 hours</small>
                          </h6>
                          <p>
                          ...
                          <p className="small text-muted mt-2 mb-0">
                            <span>
                              <i className="icon-star mr-1"></i>4
                            </span>
                            <span className="ml-2">
                              <i className="icon-speech mr-1"></i>11
                            </span>
                            <span className="ml-2">
