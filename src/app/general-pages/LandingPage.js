              ...
              <div className="row">
                <div className="col-lg-4">
                  ...
                  <div className="d-flex pt-5 pb-5">
                    <div className="social-icons bg-info text-white"><span className="icon-social-facebook"></span></div>
                    <div className="social-icons bg-secondary text-white"><span className="icon-social-pinterest"></span></div>
                    <div className="social-icons bg-danger text-white"><span className="icon-social-dribbble"></span></div>
                    <div className="social-icons bg-info text-white"><span className="icon-social-twitter"></span></div>
                  </div>
                </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-sm-4">
                <h4>Hand-crafted &amp; made with <i className=" icon-heart text-danger d-inline-block"></i>
                </h4>
              </div>
            </div>
          </div>
