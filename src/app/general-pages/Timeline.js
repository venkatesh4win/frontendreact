                    ...
                    <div className="timeline-wrapper timeline-wrapper-warning">
                      ...
                      <div className="timeline-panel">
                        ...
                        <div className="timeline-footer d-flex align-items-center flex-wrap">
                            <i className=" icon-heart text-muted mr-1"></i>
                            <span>19</span>
                            <span className="ml-md-auto font-weight-semibold">19 Oct 2017</span>
                        </div>
                      </div>
                    </div>
                    <div className="timeline-wrapper timeline-inverted timeline-wrapper-danger">
                      ...
                      <div className="timeline-panel">
                        ...
                        <div className="timeline-footer d-flex align-items-center flex-wrap">
                            <i className=" icon-heart text-muted mr-1"></i>
                            <span>25</span>
                            <span className="ml-md-auto font-weight-semibold">10th Aug 2017</span>
                        </div>
                      </div>
                    </div>
                    <div className="timeline-wrapper timeline-wrapper-success">
                      ...
                      <div className="timeline-panel">
                        ...
                        <div className="timeline-footer d-flex align-items-center flex-wrap">
                            <i className=" icon-heart text-muted mr-1"></i>
                            <span>19</span>
                            <span className="ml-md-auto font-weight-semibold">5th Sep 2016</span>
                        </div>
                      </div>
                    </div>
                    <div className="timeline-wrapper timeline-inverted timeline-wrapper-info">
                      ...
                      <div className="timeline-panel">
                        ...
                        <div className="timeline-footer d-flex align-items-center flex-wrap">
                            <i className=" icon-heart text-muted mr-1"></i>
                            <span>19</span>
                            <span className="ml-md-auto font-weight-semibold">27th July 2016</span>
                        </div>
                      </div>
                    </div>
                    <div className="timeline-wrapper timeline-wrapper-primary">
                      ...
                      <div className="timeline-panel">
                        ...
                        <div className="timeline-footer d-flex align-items-center flex-wrap">
                            <i className=" icon-heart text-muted mr-1"></i>
                            <span>25</span>
                            <span className="ml-md-auto font-weight-semibold">25th July 2016</span>
                        </div>
                      </div>
                    </div>
                    <div className="timeline-wrapper timeline-inverted timeline-wrapper-info">
                      ...
                      <div className="timeline-panel">
                        ...
                        <div className="timeline-footer d-flex align-items-center flex-wrap">
                            <i className=" icon-heart text-muted mr-1"></i>
                            <span>32</span>
                            <span className="ml-md-auto font-weight-semibold">19th Aug 2015</span>
                        </div>
                      </div>
                    </div>
                    <div className="timeline-wrapper timeline-wrapper-success">
                      ...
                      <div className="timeline-panel">
                        ...
                        <div className="timeline-footer d-flex align-items-center flex-wrap">
                            <i className=" icon-heart text-muted mr-1"></i>
                            <span>26</span>
                            <span className="ml-md-auto font-weight-semibold">15th Jun 2015</span>
                        </div>
                      </div>
                    </div>
                  </div>
